      ...
      <div className="text-center mb-12 z-10">
        <div className="mb-6 inline-block">
          <img
            ...
            className="w-56 h-56 md:w-64 md:h-64 rounded-full object-cover border-4 border-rose-400 shadow-2xl mx-auto mb-4"
          />
        </div>
        <h1 className="text-4xl md:text-5xl text-rose-600 mb-4 drop-shadow-sm font-script leading-tight">
          Nusrat Jahan Prity Chowdhury,
          <span className="block mt-4 text-3xl md:text-3xl">Will you be my Valentine?</span>
        </h1>
